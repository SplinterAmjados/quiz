...
class Evaluation
{
    ...
    public function getStatus(){
        if (intval($this->getRhScore()) === 1 || intval($this->getTechnicalScore()) === 1){
            return 'rejected';
        }

        if ($this->getRhScore() === null || $this->getTechnicalScore() === null){
            return null;
        }

        if (intval($this->getRhScore()) === 3 || intval($this->getTechnicalScore()) === 3){
            return 'accepted';
        }
